package com.test.translator_kmm.core.presentation

import androidx.annotation.DrawableRes
import com.test.translator_kmm.R
import com.test.translator_kmm.core.domain.language.Language
import java.util.*

actual class UiLanguage(
    @DrawableRes val drawableRes: Int, actual val language: Language
) {
    ...
    actual companion object {
        ...
        actual val allLanguages: List<UiLanguage>
            get() = Language.values().map { language ->
                UiLanguage(
                    language = language, drawableRes = when (language) {
